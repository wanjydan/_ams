            ...
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li><a class="parent-item" href="{{route('regions.index')}}">Regions</a>&nbsp;<i class="fa fa-angle-right"></i>
                        </li>
            ...
            <div class="row">
                <div class="offset-md-3 col-md-6 col-sm-6">
                    <div class="card card-box">
                        <div class="card-head">
                            <header>Region Information</header>
                        ...
                        <div class="card-body " id="bar-parent">
                            <form method="post" action="{{route('regions.update', $region->id)}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="id" name="id" value="{{$region->id}}" disabled>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="offset-md-3 col-md-9">
                                        ...
                                        <a class="btn btn-default" href="{{route('regions.index')}}">Cancel</a>
                                    </div>
                                </div>
                            </form>
                        </div>
