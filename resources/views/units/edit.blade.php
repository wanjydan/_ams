        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Edit Unit</div>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 col-sm-12">
                                        ...
                                        <input type="number" class="form-control" id="id" name="id"
                                               value="{{$unit->id}}" readonly>
                                    </div>
                                    <div class="form-group col-md-6 col-sm-12">
                                        <label for="number">House Number</label>
                                        <input type="text" class="form-control" id="number" name="number"
                                               value="{{$unit->number}}" required>
                                    </div>
                                    <div class="form-group col-md-6 col-sm-12">
                                        <label for="apartment">Apartment</label>
                                        <select class="form-control" id="apartment" name="apartment" required>
                                            @forelse($apartments as $apartment)
                                                <option {{$apartment->id==$unit->apartment->id ? 'selected' : null}} value="{{$apartment->id}}">{{$apartment->name}}</option>
                                            @empty
                                            @endforelse
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6 col-sm-12">
                                        ...
                                        <select class="form-control" id="type" name="type" required>
                                            @forelse($unitTypes as $unitType)
                                                <option {{$unitType->id==$unit->type->id ? 'selected' : null}} value="{{$unitType->id}}">{{$unitType->name}}</option>
                                            @empty
                                            @endforelse
                                        </select>
                                    </div>
